...
# Detect base directory (parent of where this script runs)
...
if [ -f "$RUNT_FILE" ]; then
  ...
  W1_PORT="5000"; W1_KEY="your-api-key-1"; W1_MODEL="minimaxai/minimax-m3"
  W2_PORT="5001"; W2_KEY="your-api-key-2"; W2_MODEL="minimaxai/minimax-m3"
  W3_PORT="5002"; W3_KEY="your-api-key-3"; W3_MODEL="minimaxai/minimax-m3"
fi
...
INSTANCE_w2_SETTINGS_DIR=".claude-w2"
INSTANCE_w2_NAME="w2"
...
INSTANCE_w3_SETTINGS_DIR=".claude-w3"
INSTANCE_w3_NAME="w3"
